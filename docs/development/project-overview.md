# SpaceNotch — vue d'ensemble technique

> La page d'accueil du dépôt ([README](../../README.md)) présente le produit ; cette page garde la
> vue d'ensemble technique : philosophie, mesures, technologie, construction, structure.
...
Le plan de refonte est dans [SpaceNotch 2.0](../ux/spacenotch-2.0.md) : notch attachée
([ADR-017](../decisions/ADR-017-notch-attachee.md)), présentation Hidden / Compact / Preview /
...
par un tiers. Voir [plugin-api.md](../plugin-api.md).
...
- [Architecture](../architecture.md) — les couches et la direction des dépendances
- [Machine à états](../state-machine.md) — états, transitions, arbitrage
- [Système d'activités](../activity-system.md) — le modèle et son cycle de vie
- [Système d'animation](../animation-system.md) — le ressort et la dissolution
- [Performance](../performance.md) — les règles et les mesures
- [API de greffons](../plugin-api.md) — écrire une fonctionnalité
- [Intégration Windows](../windows-integration.md) — fenêtres, DPI, API système
- [Décisions](../decisions/README.md) — pourquoi chaque choix structurant a été fait
- [Développement](../development/building.md) — construire, tester, conventions
