...
using NotchFlow.Features.Clipboard;
using NotchFlow.Features.FileShelf;
using NotchFlow.Features.Launcher;
using NotchFlow.Features.Media;
using NotchFlow.Features.Notifications;
using NotchFlow.Features.Productivity;
using NotchFlow.Features.SystemHud;
...
using NotchFlow.Platform.Windows.Bluetooth;
using NotchFlow.Platform.Windows.Clipboard;
using NotchFlow.Platform.Windows.Display;
using NotchFlow.Platform.Windows.Media;
using NotchFlow.Platform.Windows.Notifications;
using NotchFlow.Platform.Windows.Shell;
using NotchFlow.Platform.Windows.System;
using NotchFlow.Platform.Windows.Windowing;
using NotchFlow_App.Composition;
using NotchFlow_App.Controllers;
using NotchFlow_App.Diagnostics;
...
public sealed partial class IslandWindow : Window
{
    ...
    private static string BuildSubhead(IslandActivity activity)
    {
        ...
        if (detail.Length == 0)
        {
            return state.Length == 0 ? "NotchFlow" : state;
        }
