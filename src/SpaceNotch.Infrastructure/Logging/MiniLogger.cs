...
namespace SpaceNotch.Infrastructure.Logging;
...
public static class MiniLogger
{
    ...
    static MiniLogger()
    {
        ...
        LogPath = Path.Combine(LogDirectory, "spacenotch.log");

        WriterThread = new Thread(DrainQueue)
        {
            IsBackground = true,
            Name = "SpaceNotch.LogWriter"
        };
    }
    ...
    private static void Rotate()
    {
        try
        {
            string archive = Path.Combine(LogDirectory, "spacenotch.previous.log");
