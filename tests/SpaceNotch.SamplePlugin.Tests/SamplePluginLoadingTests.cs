...
{
    private const string AssemblyFileName = "SpaceNotch.SamplePlugin.Weather.dll";
    ...
    public void TheSamplePlugin_DoesNotDependOnTheContractAssemblyOfItsOwnCopy()
    {
        ...
        // Le dossier contient l'assemblage du greffon mais pas SpaceNotch.Core : la
        ...
        Assert.False(File.Exists(Path.Combine(_directory, "SpaceNotch.Core.dll")));
